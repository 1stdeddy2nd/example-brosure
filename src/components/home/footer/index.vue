...
<template>
  <section class="bg-blue-dark text-white fs-8 py-4">
    <div class="max-w-md mx-auto d-flex justify-content-md-between gap-2 justify-content-center flex-column flex-md-row align-items-center px-3">
